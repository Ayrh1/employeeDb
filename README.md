...
const api = require('./js/index.js'); // import route index.js 
const sideQuestions = require('js/sideQuestions.js');
...
const db = mysql.createConnection(
  ...
  console.log(`Connected to the personnelData_db database.`)
);
